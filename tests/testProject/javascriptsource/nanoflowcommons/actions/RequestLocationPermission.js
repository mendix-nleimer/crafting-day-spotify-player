...
export async function RequestLocationPermission() {
    ...
    const hasPermissionIOS = async () => {
        ...
        return geolocationModule.requestAuthorization("whenInUse").then(status => {
            if (status === "granted") {
                return true;
            }
            if (status === "denied") {
    ...
    const hasPermissionAndroid = async () => {
        ...
        if (
            typeof ((_a =
                reactNativeModule === null || reactNativeModule === void 0 ? void 0 : reactNativeModule.Platform) ===
                null || _a === void 0
                ? void 0
                : _a.Version) === "number" &&
            ((_b = reactNativeModule === null || reactNativeModule === void 0 ? void 0 : reactNativeModule.Platform) ===
                null || _b === void 0
                ? void 0
                : _b.Version) < 23
        ) {
        ...
        return reactNativeModule === null || reactNativeModule === void 0
            ? void 0
            : reactNativeModule.PermissionsAndroid.check(androidLocationPermission).then(hasPermission => {
                  var _a;
                  return hasPermission
                      ...
                      : (_a =
                            reactNativeModule === null || reactNativeModule === void 0
                                ? void 0
                                : reactNativeModule.PermissionsAndroid) === null || _a === void 0
                      ? void 0
                      : _a.request(androidLocationPermission).then(status => {
                            ...
                            if (
                                ...
                                (reactNativeModule === null || reactNativeModule === void 0
                                    ? void 0
                                    : reactNativeModule.PermissionsAndroid.RESULTS.NEVER_ASK_AGAIN)
                            ) {
                                reactNativeModule.ToastAndroid.show(
    ...
    const hasLocationPermission = async () => {
        if (
            (reactNativeModule === null || reactNativeModule === void 0 ? void 0 : reactNativeModule.Platform.OS) ===
            "ios"
        ) {
